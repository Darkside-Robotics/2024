...
public final class Constants {
    ...
    public static final class ModuleConstants {
        ...
        public static final double kDriveMotorGearRatio = 1;  //Need
        public static final double kTurningMotorGearRatio = 1; //Need
    ...
    public static final class DriveConstants {
        ...
        public static final double kTrackWidth = Units.inchesToMeters(1); //Need
        // Distance between right and left wheels
        public static final double kWheelBase = Units.inchesToMeters(1); //Need
        ...
        public static final double kFrontLeftDriveAbsoluteEncoderOffsetRad = 0;  //NEED
